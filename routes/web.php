...
Route::get('/pieza/{id}',[PiezaController::class, 'getPieza'])->name('PiezaVista');
Route::patch('/pieza/edit/{id}',[PiezaController::class, 'updatePieza'])->name('PiezaEditar');
Route::patch('/pieza/update/{id}', [PiezaController::class, 'updatePartStatus'])->name('PiezaActualizar');
Route::delete('/pieza/delete/{id}',[PiezaController::class, 'deletePieza'])->name('PiezaEliminar');
